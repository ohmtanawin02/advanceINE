...
#เวลาจะ INSERT แต่ละครั้งต้องมี cursor.execute ข้างใต้ insert ทุกครั้ง
    ...
    #postgres_insert_query = ''' INSERT INTO midtermJA (student_id, f_name, l_name, e_mail) VALUES (%s,%s,%s,%s)'''
    #record_to_insert = ('OHM', 'Tanawin',
                        #'Jenkunnaphat', '6206022620039@fitm.kmutnb.ac.th')
    postgres_insert_query = ''' INSERT INTO midtermJA (student_id, f_name, l_name, e_mail) VALUES (%s,%s,%s,%s)'''
    record_to_insert = ('KUB', 'wanmai',
                        'jaja', '8415123156@fitm.kmutnb.ac.th')
    cursor.execute(postgres_insert_query, record_to_insert)
